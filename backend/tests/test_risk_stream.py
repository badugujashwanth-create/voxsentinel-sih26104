...
def test_stream_payloads_satisfy_the_frontend_contract(client: TestClient, live_call_id: str) -> None:
    ...
    for payload in drain(client, live_call_id):
        ...
        optional_fields = {"evidence_availability", "synthetic_score_semantics", "inference_latency_ms", "provider_round_trip_ms", "preprocessing_latency_ms", "audio_source_frame_start", "audio_source_frame_end", "audio_source_transport_sequence_start", "audio_source_transport_sequence_end", "audio_source_gap_count", "audio_window_sequence"}
